        ...
        steps {
            steps {
                shell('#!/bin/bash' + newLine +
                        ...
                        'curl -v -f http://admin:admin123@nexus-v2.cc-ci-cd.svc:8081/nexus/service/local/repositories/releases/content/com/example/react/cc-fe/0.0.1-${BUILD_TAG}/cc-fe-0.0.1-${BUILD_TAG}.zip -o cc-fe.zip' + newLine +
