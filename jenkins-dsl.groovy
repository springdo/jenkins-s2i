...
pipelineNames.each {
    ...
    buildImageName = it + "-" + backendName + "-build"
    bakeImageName = it + "-" + backendName + "-bake"
    deployImageName = it + "-" + backendName + "-deploy"
    jobDescription = "THIS JOB WAS GENERATED BY THE JENKINS SEED JOB - ${pipelineGeneratorVersion}.  \n"  + it + " backend build job for the app."
